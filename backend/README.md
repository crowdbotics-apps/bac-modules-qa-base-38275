...
## Project Structure
    ...
    ├── bac_modules_qa_base_38275  # Django project configurations
...
1. Clone this repo and `cd bac_modules_qa_base_38275`
...
2. Clone this repo and `cd bac_modules_qa_base_38275`
